...
export default function CompareNotebooksPage() {
  return (
    <div className="max-w-[1000px]">
      <div className="text-[13px] text-gray-500 mb-1 flex items-center gap-2">
        <span>Organize / Tools</span>
        <span className="text-gray-300">/</span>
        <span className="text-gray-900 font-medium">Compare Notebooks</span>
      </div>
      <h1 className="text-[32px] font-bold text-gray-900 tracking-tight mb-8">Compare Notebooks</h1>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-12 flex flex-col items-center justify-center text-center min-h-[400px] shadow-sm">
        ...
        <h3 className="text-lg font-bold text-gray-900 mb-2">No compare notebooks found</h3>
