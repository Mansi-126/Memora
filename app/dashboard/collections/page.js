...
export default function CollectionsPage() {
  return (
    <div className="max-w-[1000px]">
      ...
      <h1 className="text-[32px] font-bold text-gray-900 tracking-tight mb-8">Collections</h1>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-12 flex flex-col items-center justify-center text-center min-h-[400px] shadow-sm">
        ...
        <h3 className="text-lg font-bold text-gray-900 mb-2">No collections found</h3>
